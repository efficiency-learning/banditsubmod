...
class Bottleneck(nn.Module):
    ...
    # according to "Deep residual learning for image recognition"XXXX.
...
class ResNet(nn.Module):
    def __init__(
        ...
        # This improves the model by 0.2~0.3% according to XXXX
...
def ResNet18(num_classes: int, **kwargs: Any) -> ResNet:
    """ResNet-18 from `Deep Residual Learning for Image Recognition XXXX`__.
    Args:
...
def ResNet34(num_classes: int, **kwargs: Any) -> ResNet:
    """ResNet-34 from `Deep Residual Learning for Image Recognition XXXX`__.
    Args:
...
def ResNet50(num_classes: int, **kwargs: Any) -> ResNet:
    """ResNet-50 from `Deep Residual Learning for Image Recognition XXXX`__.
    .. note::
...
def ResNet101(num_classes: int, **kwargs: Any) -> ResNet:
    """ResNet-101 from `Deep Residual Learning for Image Recognition XXXX`__.
    .. note::
       The bottleneck of TorchVision places the stride for downsampling to the second 3x3
       convolution while the original paper places it to the first 1x1 convolution.
       This variant improves the accuracy and is known as `ResNet V1.5
...
def ResNet152(num_classes: int, **kwargs: Any) -> ResNet:
    """ResNet-152 from `Deep Residual Learning for Image Recognition XXXX`__.
    .. note::
       The bottleneck of TorchVision places the stride for downsampling to the second 3x3
       convolution while the original paper places it to the first 1x1 convolution.
       This variant improves the accuracy and is known as `ResNet V1.5
       XXXXalog/model-scripts/nvidia:resnet_50_v1_5_for_pytorch>`_.
    Args:
...
def ResNext50_32x4d(num_classes: int, **kwargs: Any) -> ResNet:
    ...
    `Aggregated Residual Transformation for Deep Neural Networks XXXX`_.
    Args:
